  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-background via-secondary/5 to-primary/5 flex items-center justify-center p-4 md:p-8">
      <div className="w-full max-w-[450px] relative">
        ...
        {/* Content */}
        <div className="relative bg-background/60 backdrop-blur-sm rounded-[2rem] p-8 md:p-10 shadow-sm border border-border/40">
          <div className="space-y-2 mb-8">
            <h1 className="text-4xl font-semibold tracking-tight text-foreground/90 animate-fade-in">
              {title}
            </h1>
            <p className="text-base text-muted-foreground animate-fade-in [animation-delay:200ms]">
              {subtitle}
            </p>
          </div>
          {children}
